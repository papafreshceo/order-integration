...
function displaySupportedMarkets(markets) {
    ...
    headerDiv.innerHTML = svgIcon + '<h3 style="margin: 0;">Excel 업로드</h3>';
    container.innerHTML = '';
...
function displayResultTable(data) {
    ...
    const rightAlignFields = ['셀러공급가','출고비용' , '정산예정금액', '정산대상금액' , '상품금액','최종결제금액', '할인금액','마켓부담할인액','판매자할인쿠폰할인','구매쿠폰적용금액','쿠폰할인금액','기타지원금할인금', '수수료1', '수수료2', 
                                 '택배비'];
    ...
    data.forEach((row, rowIndex) => {
        ...
        headers.forEach((header, index) => {
            ...
            // 금액 포맷팅
            const amountFields = ['셀러공급가','출고비용' , '정산예정금액', '정산대상금액' , '상품금액','최종결제금액', '할인금액','마켓부담할인액','판매자할인쿠폰할인','구매쿠폰적용금액','쿠폰할인금액','기타지원금할인금', '수수료1', '수수료2', 
                                 '택배비'];
